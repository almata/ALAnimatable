#
#  Be sure to run `pod spec lint ALAnimatable.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Albert Mata"
  # s.authors            = { "Albert Mata" => "hello@albertmata.net" }
  ...
  s.source       = { :git => "https://github.com/almata/ALAnimatable.git", :tag => "0.0.1" }
